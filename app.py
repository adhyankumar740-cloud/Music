...
# FIX for 404: Webhook Path को सरल करें, क्योंकि Telegram बार-बार 404 दे रहा है।
# हम इसे 'SECRET_PATH' बनाते हैं जो केवल Webhook के लिए उपयोग होता है।
...
def set_webhook():
    ...
    # FIX 404: Webhook URL में सही, secure path शामिल करें
