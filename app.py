...
import threading 
import re 
import httpx # <-- FIXED: For YouTube search API calls
...
try:
    ...
    # यदि eventlet नहीं मिला, तो threading पर वापस आएँ (उत्पादन के लिए अनुशंसित नहीं)
...
# --- Global Objects ---
app = Flask(__name__)
# Flask-SocketIO initialization (CORS configured for any origin, which is crucial for Render)
...
async def play_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # FIX: Ensure RENDER_FRONTEND_URL uses HTTPS if possible
...
# ------------------------------------------------------------------
# --- WEBHOOK ENDPOINT (FIXED: asyncio.run removed) ---
# ------------------------------------------------------------------
...
def telegram_webhook():
    if request.method == "POST":
        ...
        try:
            ...
            # FIX: eventlet के साथ संगतता के लिए asyncio.run() हटाएँ
