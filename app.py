...
import asyncio
import re 
import requests # YouTube API कॉल करने के लिए
...
YOUTUBE_API_KEY = os.getenv("YOUTUBE_API_KEY") # NEW: YouTube API Key for Search
...
# --- Global Objects ---
app = Flask(__name__)
# Flask-SocketIO initialization: CORS enabled for frontend and threading mode for compatibility
...
async def play_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # FrontEnd को सर्च मोड में शुरू करने के लिए mode=search पास करें
...
def setup_handlers(app_ptb: Application):
    ...
    app_ptb.add_handler(error_handler)
    logger.info("All handlers set up.")

# ------------------------------------------------------------------
# --- PTB Initialization with Auto Webhook ---
# ------------------------------------------------------------------
...
# ------------------------------------------------------------------
# --- YOUTUBE DATA API SEARCH ENDPOINT (NEW) ---
# ------------------------------------------------------------------
...
def search_youtube():
    ...
    if not YOUTUBE_API_KEY:
        # अगर API Key सेट नहीं है, तो क्लाइंट को बताएं
...
# ------------------------------------------------------------------
# --- SOCKETIO (REAL-TIME GROUP LISTENING) HANDLERS (Unchanged) ---
# ------------------------------------------------------------------
